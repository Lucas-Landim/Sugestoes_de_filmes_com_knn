...
# Criação do tokenizador baseado em expressões regulares para remover símbolos, números e palavras com menos de 3 letras
token = RegexpTokenizer(r'\b[a-zA-Z]{2,}\b') # Expressão regular para remover simbolos, números e palavras com menos de 3 letras

# Tokenização para a coluna 'title'
...
description_counts = cv.fit_transform(dataset['description'])
# Tokenização para a coluna 'description'

# Converte a matriz esparsa em um DataFrame para melhor visualizar
description_counts = pd.DataFrame(description_counts.toarray(), columns=cv.get_feature_names_out())
print(description_counts)

##------------------------------------------------------------
## Separa os dados em treinamento e teste
##------------------------------------------------------------
y = dataset['title']   # Carrega alvo 
X = description_counts            # Carrega as colunas geradas
